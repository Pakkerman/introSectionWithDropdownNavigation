...
export const ButtonBlack = ({ text }: ButtonProps) => {
  return (
    <button className="border- group rounded-2xl border-[1.5px] bg-AlmostBlack px-6 py-3 font-bold hover:cursor-pointer hover:border-AlmostBlack hover:bg-AlmostWhite">
